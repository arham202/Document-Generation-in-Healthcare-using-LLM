...
import 'package:nlp_app/validations/insulin_validation.dart';
import 'package:speech_to_text/speech_to_text.dart' as stt;

class InsulinEntryBottomSheet extends StatefulWidget {
  const InsulinEntryBottomSheet({super.key});

  @override
  State<InsulinEntryBottomSheet> createState() =>
...
class _InsulinEntryBottomSheetState extends State<InsulinEntryBottomSheet> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              ..._buildQuestions(_insulinQuestions, _insulinFormData),
              Padding(
                padding: const EdgeInsets.all(10.0),
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async {
                        bool success = await _submitInsulinData();
                        if (success) {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => InsulinValidation()));
                        }
                      },
  ...
  Future<bool> _submitInsulinData() async {
    return await _submitData(
        _insulinFormData, 'http://10.0.2.2:5000/api/insulin_taken');
  }
